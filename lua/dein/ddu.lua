...
cmd([[
autocmd BufWinEnter ddu-ff-default lua vim.api.nvim_win_set_config(0,{border = 'rounded'});

autocmd FileType ddu-ff nnoremap <buffer> / <Cmd>call ddu#ui#ff#do_action("openFilterWindow")<CR>
